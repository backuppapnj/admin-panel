...
import { createSkInovasi, type SkInovasi } from '@/lib/api';
...
function SkInovasiForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const result = await createSkInovasi(dataToSend);
            if (result.success) {
                toast({ title: 'Sukses', description: 'SK berhasil disimpan!' });
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Formulir SK Inovasi</CardTitle>
                <CardDescription>
                    Tambahkan Surat Keputusan penetapan inovasi tahunan.
                </CardDescription>
            </CardHeader>
            <CardContent>
